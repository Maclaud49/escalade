...
<body>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Liste des secteurs
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Liste des secteurs</li>
        </ol>
            ...
            <div class="col-md-8">
                ...
                <s:iterator value="listSecteur">
                    ...
                    <s:elseif test="publication == false && utilisateur.id == #session.escalade_user.id">
                        <div class="card-footer text-muted">
                            Secteur en cours de validation de modification
                        </div>
                        <div class="card mb-4">
                            <h5 class="card-header">Modifier le secteur</h5>
                            <div class="card-body text-center">
                                <s:a action="secteur_modifier" class="btn btn-secondary"><s:param name="secteurId" value="id" />Modifier</s:a>
                            </div>
                        </div>
                    </s:elseif>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body text-center">
                        <s:if test="#session.escalade_user">
                            <s:a action="secteur_new" class="btn btn-secondary">Moi aussi je partage !</s:a>
                        </s:if>
                        <s:else>
